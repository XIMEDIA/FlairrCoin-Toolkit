...
function (t) {
  ...
  a.on = function (t, e, i) {
    this._events = u(l, this._events || {}, t, e, {
      ...
      ctx: this,
      listening: h
    }), h && (((this._listeners || (this._listeners = {}))[h.id] = h).interop = !1);
    return this
    ...
    var r = t._listenId || (t._listenId = i.uniqueId("l")),
      ...
      a = h = s[r];
    a || (this._listenId || (this._listenId = i.uniqueId("l")), a = h = s[r] = new g(this, t));
    var o = c(t, e, n, this);
  ...
  var m = e.Model = function (t, e) {
    var n = t || {};
    e || (e = {}), this.preinitialize.apply(this, arguments), this.cid = i.uniqueId(this.cidPrefix), this.attributes = {}, e.collection && (this.collection = e.collection), e.parse && (n = this.parse(n, e) || {});
  ...
  i.extend(m.prototype, a, {
    ...
    set: function (t, e, n) {
      ...
      for (var f in r) e = r[f], i.isEqual(u[f], e) || o.push(f), i.isEqual(c[f], e) ? delete l[f] : l[f] = e, s ? delete u[f] : u[f] = e;
    ...
    changedAttributes: function (t) {
      ...
      var r, e = this._changing ? this._previousAttributes : this.attributes,
        n = {};
      for (var s in t) {
        var a = t[s];
    ...
    save: function (t, e, n) {
      ...
      }, G(this, n), r && s && (this.attributes = i.extend({}, h, r));
    ...
    destroy: function (t) {
      ...
      return this.isNew() ? i.defer(t.success) : (G(this, t), a = this.sync("delete", this, t)), r || s(), a
    },
    url: function () {
  ...
  var _ = e.Collection = function (t, e) {
      e || (e = {}), this.preinitialize.apply(this, arguments), e.model && (this.model = e.model), void 0 !== e.comparator && (this.comparator = e.comparator), this._reset(), this.initialize.apply(this, arguments), t && this.reset(t, i.extend({
        silent: !0
      }, e))
    },
    y = {
  ...
  i.extend(_.prototype, a, {
    ...
    set: function (t, e) {
      if (null != t) {
        (e = i.extend({}, y, e)).parse && !this._isModel(t) && (t = this.parse(t, e) || []);
        var n = !i.isArray(t);
        t = n ? [t] : t.slice();
        var r = e.at;
        ...
        for (m = 0; m < t.length; m++) {
          ...
          if (_) {
            if (c && g !== _) {
              ...
              e.parse && (b = _.parse(b, e)), _.set(b, e), o.push(_), v && !d && (d = _.hasChanged(p))
            }
            u[_.cid] || (u[_.cid] = !0, s.push(_)), t[m] = _
          } else l && (g = t[m] = this._prepareModel(g, e)) && (a.push(g), this._addReference(g, e), u[g.cid] = !0, s.push(g))
        }
        if (f) {
        ...
        var w = !1,
          E = !v && l && f;
        if (s.length && E ? (w = this.length !== s.length || i.some(this.models, function (t, e) {
            return t !== s[e]
          }), this.models.length = 0, x(this.models, s, 0), this.length = this.models.length) : a.length && (v && (d = !0), x(this.models, a, null == r ? this.length : r), this.length = this.models.length), d && this.sort({
            silent: !0
          }), !e.silent) {
          for (m = 0; m < a.length; m++) null != r && (e.index = r + m), (g = a[m]).trigger("add", g, this, e);
          (d || w) && this.trigger("sort", this, e), (a.length || h.length || o.length) && (e.changes = {
            added: a,
            removed: h,
            merged: o
    ...
    sort: function (t) {
      ...
      t || (t = {});
      var n = e.length;
      return i.isFunction(e) && (e = e.bind(this)), 1 === n || i.isString(e) ? this.models = this.sortBy(e) : this.models.sort(e), t.silent || this.trigger("sort", this, t), this
    },
    pluck: function (t) {
      return this.map(t + "")
    },
    ...
    _removeModels: function (t, e) {
      for (var i = [], n = 0; n < t.length; n++) {
        ...
        if (r) {
          ...
          null != a && delete this._byId[a], e.silent || (e.index = s, r.trigger("remove", r, this, e)), i.push(r), this._removeReference(r, e)
        }
      }
      return i
    },
  ...
  var T = e.View = function (t) {
      this.cid = i.uniqueId("view"), this.preinitialize.apply(this, arguments), i.extend(this, i.pick(t, H)), this._ensureElement(), this.initialize.apply(this, arguments)
    },
    P = /^(\S+)\s*(.*)$/,
  ...
  var C = function (t, e) {
      return i.isFunction(t) ? t : i.isObject(t) && !e._isModel(t) ? R(t) : i.isString(t) ? function (e) {
        return e.get(t)
      } : t
    },
    R = function (t) {
  ...
  i.each([
    ...
    if (r.url || (a.url = i.result(n, "url") || V()), null != r.data || !n || "create" !== t && "update" !== t && "patch" !== t || (a.contentType = "application/json", a.data = JSON.stringify(r.attrs || n.toJSON(r))), r.emulateJSON && (a.contentType = "application/x-www-form-urlencoded", a.data = a.data ? {
        model: a.data
    ...
    r.error = function (t, e, i) {
      r.textStatus = e, r.errorThrown = i, h && h.call(r.context, t, e, i)
    };
  ...
  i.extend(O.prototype, a, {
    ...
    route: function (t, n, r) {
      ...
      return e.history.route(t, function (i) {
        ...
        !1 !== s.execute(r, a, n) && (s.trigger.apply(s, ["route:" + n].concat(a)), s.trigger("route", n, a), e.history.trigger("route", s, n, a))
      }), this
    },
    ...
    _routeToRegExp: function (t) {
      return t = t.replace(F, "\\$&").replace(U, "(?:$1)?").replace(z, function (t, e) {
        return e ? t : "([^/?]+)"
      }).replace(q, "([^?]*?)"), new RegExp("^" + t + "(?:\\?([\\s\\S]*))?$")
    },
  ...
  var B = e.History = function () {
    ...
    L = /^\/+|\/+$/g,
    W = /#.*$/;
  B.started = !1, i.extend(B.prototype, a, {
    interval: 50,
    atRoot: function () {
    ...
    getFragment: function (t) {
      return null == t && (t = this._usePushState || !this._wantsHashChange ? this.getPath() : this.getHash()), t.replace(J, "")
    },
    start: function (t) {
      if (B.started) throw new Error("Backbone.history has already been started");
      if (B.started = !0, this.options = i.extend({
          root: "/"
    ...
    stop: function () {
      ...
      this._usePushState ? t("popstate", this.checkUrl, !1) : this._useHashChange && !this.iframe && t("hashchange", this.checkUrl, !1), this.iframe && (document.body.removeChild(this.iframe), this.iframe = null), this._checkUrlInterval && clearInterval(this._checkUrlInterval), B.started = !1
    },
    route: function (t, e) {
    ...
    navigate: function (t, e) {
      ...
      if (this.fragment !== r) {
        if (this.fragment = r, this._usePushState) this.history[e.replace ? "replaceState" : "pushState"]({}, document.title, n);
        else {
  ...
  m.extend = _.extend = O.extend = T.extend = B.extend = function (t, e) {
    var r, n = this;
    return r = t && i.has(t, "constructor") ? t.constructor : function () {
      return n.apply(this, arguments)
    }, i.extend(r, n, e), r.prototype = i.create(n.prototype, t), (r.prototype.constructor = r).__super__ = n.prototype, r
  };
  var V = function () {
...
function () {
  ...
  e.version = "2.3.7", e.utils = {}, e.utils.warn = function (e) {
      return function (t) {
      ...
      return null == this._stringValue && (this._stringValue = this.fieldName + e.FieldRef.joiner + this.docRef), this._stringValue
    }, e.Set = function (e) {
      ...
      i = this.length < t.length ? (r = this, t) : (r = t, this), n = Object.keys(r.elements);
      ...
      return s
    }, e.tokenizer.separator = /[\s\-]+/, e.Pipeline = function () {
      this._stack = []
    }, e.Pipeline.registeredFunctions = Object.create(null), e.Pipeline.registerFunction = function (t, r) {
      r in this.registeredFunctions && e.utils.warn("Overwriting existing registered function: " + r), t.label = r, e.Pipeline.registeredFunctions[t.label] = t
      ...
      var e = {
        ...
        h = new RegExp("^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*[aeiouy][aeiou]*[^aeiou][^aeiouy]*"),
        ...
        I = function (r) {
          ...
          if ("y" == (s = r.substr(0, 1)) && (r = s.toUpperCase() + r.substr(1)), a = y, (o = p).test(r) ? r = r.replace(o, "$1$2") : a.test(r) && (r = r.replace(a, "$1$2")), a = v, (o = m).test(r)) {
            var I = o.exec(r);
            (o = c).test(I[1]) && (o = g, r = r.replace(o, ""))
          } else if (a.test(r)) {
            i = (I = a.exec(r))[1], (a = f).test(i) && (u = w, l = Q, (a = x).test(r = i) ? r += "e" : u.test(r) ? (o = g, r = r.replace(o, "")) : l.test(r) && (r += "e"))
          }(o = k).test(r) && (r = (i = (I = o.exec(r))[1]) + "i");
          (o = S).test(r) && (i = (I = o.exec(r))[1], n = I[2], (o = c).test(i) && (r = i + e[n]));
          (o = E).test(r) && (i = (I = o.exec(r))[1], n = I[2], (o = c).test(i) && (r = i + t[n]));
          if (a = b, (o = L).test(r)) i = (I = o.exec(r))[1], (o = h).test(i) && (r = i);
          else if (a.test(r)) {
            i = (I = a.exec(r))[1] + I[2], (a = h).test(i) && (r = i)
          }(o = P).test(r) && (i = (I = o.exec(r))[1], a = d, u = O, ((o = h).test(i) || a.test(i) && !u.test(i)) && (r = i));
          return a = h, (o = T).test(r) && a.test(r) && (o = g, r = r.replace(o, "")), "y" == s && (r = s.toLowerCase() + r.substr(1)), r
        };
      return function (e) {
        return e.update(I)
      }
    ...
    }, e.Pipeline.registerFunction(e.trimmer, "trimmer"), e.TokenSet = function () {
      ...
      for (var i = new e.TokenSet, n = [{
        ...
        if (0 < s.str.length) {
          ...
          a in s.node.edges ? o = s.node.edges[a] : (o = new e.TokenSet, s.node.edges[a] = o), 1 == s.str.length && (o.final = !0), n.push({
            node: o,
        ...
        if (0 != s.editsRemaining) {
          ...
          if (0 == s.str.length && (u.final = !0), n.push({
              ...
              editsRemaining: s.editsRemaining - 1,
              str: s.str.slice(1)
            }), 1 == s.str.length && (s.node.final = !0), 1 <= s.str.length) {
          ...
          if (1 < s.str.length) {
            var c, h = s.str.charAt(0),
              d = s.str.charAt(1);
            d in s.node.edges ? c = s.node.edges[d] : (c = new e.TokenSet, s.node.edges[d] = c), 1 == s.str.length && (c.final = !0), n.push({
              node: c,
              editsRemaining: s.editsRemaining - 1,
              str: h + s.str.slice(2)
            })
      ...
      for (var r = new e.TokenSet, i = void 0, n = [{
        ...
        i = n.pop();
        for (var s = Object.keys(i.qNode.edges), o = s.length, a = Object.keys(i.node.edges), u = a.length, l = 0; l < o; l++)
          for (var c = s[l], h = 0; h < u; h++) {
            ...
            if (d == c || "*" == c) {
              var f = i.node.edges[d],
                ...
                y = f.final && p.final,
                m = void 0;
              d in i.output.edges ? (m = i.output.edges[d]).final = m.final || y : ((m = new e.TokenSet).final = y, i.output.edges[d] = m), n.push({
                qNode: p,
                output: m,
                node: f
              })
      ...
      this.minimize(i), r = 0 == this.uncheckedNodes.length ? this.root : this.uncheckedNodes[this.uncheckedNodes.length - 1].child;
      for (n = i; n < t.length; n++) {
        var s = new e.TokenSet,
          o = t[n];
        r.edges[o] = s, this.uncheckedNodes.push({
          parent: r,
          char: o,
          child: s
        }), r = s
      ...
      for (var r = new e.Query(this.fields), i = Object.create(null), n = Object.create(null), s = Object.create(null), o = Object.create(null), a = Object.create(null), u = 0; u < this.fields.length; u++) n[this.fields[u]] = new e.Vector;
      t.call(r, r);
          ...
          for (var g = 0; g < y.length; g++) {
            ...
            for (m = 0; m < l.fields.length; m++) {
              var k = w[v = l.fields[m]],
                ...
                E = x + "/" + v,
                L = new e.Set(S);
              if (l.presence == e.Query.presence.REQUIRED && (h = h.union(L), void 0 === o[v] && (o[v] = e.Set.complete)), l.presence != e.Query.presence.PROHIBITED) {
      ...
      for (u = 0; u < this.fields.length; u++) {
        var v;
        o[v = this.fields[u]] && (R = R.intersect(o[v])), a[v] && (F = F.union(a[v]))
      }
      var C = Object.keys(i),
        N = [],
      ...
      return a.finish(), r.fields = t.fields, r.fieldVectors = i, r.invertedIndex = s, r.tokenSet = a.root, r.pipeline = u, new e.Index(r)
    }, e.Builder = function () {
      this._ref = "id", this._fields = Object.create(null), this._documents = Object.create(null), this.invertedIndex = Object.create(null), this.fieldTermFrequencies = {}, this.fieldLengths = {}, this.tokenizer = e.tokenizer, this.pipeline = new e.Pipeline, this.searchPipeline = new e.Pipeline, this.documentCount = 0, this._b = .75, this._k1 = 1.2, this.termIndex = 0, this.metadataWhitelist = []
      ...
      for (var s = 0; s < n.length; s++) {
        ...
        for (var f = 0; f < c.length; f++) {
          ...
          null == this.invertedIndex[p][o][i] && (this.invertedIndex[p][o][i] = Object.create(null));
          for (var v = 0; v < this.metadataWhitelist.length; v++) {
            var g = this.metadataWhitelist[v],
              x = p.metadata[g];
            null == this.invertedIndex[p][o][i][g] && (this.invertedIndex[p][o][i][g] = []), this.invertedIndex[p][o][i][g].push(x)
          }
        }
      }
      ...
      for (var t = {}, r = Object.keys(this.fieldTermFrequencies), i = r.length, n = Object.create(null), s = 0; s < i; s++) {
        for (var o = e.FieldRef.fromString(r[s]), a = o.fieldName, u = this.fieldLengths[o], l = new e.Vector, c = this.fieldTermFrequencies[o], h = Object.keys(c), d = h.length, f = this._fields[a].boost || 1, p = this._documents[o.docRef].boost || 1, y = 0; y < d; y++) {
          var m, v, g, x = h[y],
            w = c[x],
            Q = this.invertedIndex[x]._index;
          void 0 === n[x] ? (m = e.idf(this.invertedIndex[x], this.documentCount), n[x] = m) : m = n[x], v = m * ((this._k1 + 1) * w) / (this._k1 * (1 - this._b + this._b * (u / this.averageFieldLength[a])) + w), v *= f, v *= p, g = Math.round(1e3 * v) / 1e3, l.insert(Q, g)
        }
        t[o] = l
      }
      this.fieldVectors = t
    ...
    }, e.QueryParseError.prototype = new Error, e.QueryLexer = function (e) {
      ...
      if (1 < t.width() && (t.backup(), t.emit(e.QueryLexer.TERM)), t.ignore(), t.more()) return e.QueryLexer.lexText
      ...
      for (;;) {
        ...
        if (92 != r.charCodeAt(0)) {
          ...
          if ("~" == r) return t.backup(), 0 < t.width() && t.emit(e.QueryLexer.TERM), e.QueryLexer.lexEditDistance;
          if ("^" == r) return t.backup(), 0 < t.width() && t.emit(e.QueryLexer.TERM), e.QueryLexer.lexBoost;
      ...
      if (null != r) switch (r.type) {
        ...
        default:
          ...
          throw 1 <= r.str.length && (i += " with value '" + r.str + "'"), new e.QueryParseError(i, r.start, r.end)
      }
      ...
      var r = t.consumeLexeme();
      if (null != r) {
        t.currentClause.term = r.str.toLowerCase(), -1 != r.str.indexOf("*") && (t.currentClause.usePipeline = !1);
        var i = t.peekLexeme();
...
var __extends = this && this.__extends || function () {
  ...
  typedoc, typedoc, typedoc, typedoc, typedoc, typedoc, typedoc, typedoc, typedoc, typedoc;
! function (typedoc) {
  typedoc.$html = $("html");
  var services = [],
    components = [];
  typedoc.$document = $(document), typedoc.$window = $(window), typedoc.$body = $("body"), typedoc.registerService = function (constructor, name, priority) {
  ...
  }, typedoc.registerComponent = function (constructor, selector, priority, namespace) {
  ...
  }, "undefined" != typeof Backbone && (typedoc.Events = function () {}, _.extend(typedoc.Events.prototype, Backbone.Events));
    ...
    return __extends(Application, _super), Application.prototype.createServices = function () {
      ...
      return _(components).forEach(function (c) {
        c.namespace != namespace && "*" != c.namespace || $context.find(c.selector).each(function (m, el) {
          var instance, $el = $(el);
          (instance = $el.data("component")) ? -1 == _(result).indexOf(instance) && result.push(instance): (instance = new c.constructor({
            el: el
          }), $el.data("component", instance), result.push(instance))
        })
      }), result
    }, Application
  }(typedoc.Events);
...
function (typedoc) {
  var Viewport = function (_super) {
    function Viewport() {
      var _this = _super.call(this) || this;
      return _this.scrollTop = 0, _this.lastY = 0, _this.width = 0, _this.height = 0, _this.showToolbar = !0, _this.toolbar = document.querySelector(".tsd-page-toolbar"), _this.secondaryNav = document.querySelector(".tsd-navigation.secondary"), typedoc.$window.on("scroll", _.throttle(function () {
        return _this.onScroll()
      }, 10)), typedoc.$window.on("resize", _.throttle(function () {
        return _this.onResize()
      }, 10)), _this.onResize(), _this.onScroll(), _this
    }
    return __extends(Viewport, _super), Viewport.prototype.triggerResize = function () {
      this.trigger("resize", this.width, this.height)
    }, Viewport.prototype.onResize = function () {
      this.width = typedoc.$window.width() || 0, this.height = typedoc.$window.height() || 0, this.trigger("resize", this.width, this.height)
    }, Viewport.prototype.onScroll = function () {
      this.scrollTop = typedoc.$window.scrollTop() || 0, this.trigger("scroll", this.scrollTop), this.hideShowToolbar()
    }, Viewport.prototype.hideShowToolbar = function () {
      var isShown = this.showToolbar;
      this.showToolbar = this.lastY >= this.scrollTop || 0 === this.scrollTop, isShown !== this.showToolbar && (this.toolbar.classList.toggle("tsd-page-toolbar--hide"), this.secondaryNav.classList.toggle("tsd-navigation--toolbar-hide")), this.lastY = this.scrollTop
    }, Viewport
  }(typedoc.Events);
...
function (typedoc) {
  typedoc.pointerDown = "mousedown", typedoc.pointerMove = "mousemove", typedoc.pointerUp = "mouseup", typedoc.pointerDownPosition = {
    ...
    typedoc.pointerDownPosition.y = t.pageY || 0, typedoc.pointerDownPosition.x = t.pageX || 0
...
function (typedoc) {
  var FilterItem = function () {
      ...
      return FilterItem.prototype.initialize = function () {}, FilterItem.prototype.setValue = function (value) {
        if (this.value != value) {
    ...
    FilterItemSelect = function (_super) {
      ...
      return __extends(FilterItemSelect, _super), FilterItemSelect.prototype.initialize = function () {
        ...
        typedoc.$html.addClass("toggle-" + this.key + this.value), this.$select = $("#tsd-filter-" + this.key), this.$select.on(typedoc.pointerDown + " mouseover", function () {
          ...
          _this.$select.removeClass("active"), _this.setValue(($(e.target).attr("data-value") || "").toString())
...
function (typedoc) {
  var MenuHighlight = function (_super) {
    function MenuHighlight(options) {
      var _this = _super.call(this, options) || this;
      return _this.anchors = [], _this.index = 0, _this.listenTo(typedoc.viewport, "resize", _this.onResize), _this.listenTo(typedoc.viewport, "scroll", _this.onScroll), _this.createAnchors(), _this
    }
    return __extends(MenuHighlight, _super), MenuHighlight.prototype.createAnchors = function () {
      var _this = this;
      this.index = 0, this.anchors = [{
        position: 0
      }];
      var base = window.location.href; - 1 != base.indexOf("#") && (base = base.substr(0, base.indexOf("#"))), this.$el.find("a").each(function (_index, el) {
        var href = el.href;
      ...
      for (var anchor, index = 1, count = this.anchors.length; index < count; index++)(anchor = this.anchors[index]).position = anchor.$anchor.offset().top;
      ...
      for (scrollTop += 5; 0 < index && anchors[index].position > scrollTop;) index -= 1;
      for (; index < count && anchors[index + 1].position < scrollTop;) index += 1;
      this.index != index && (0 < this.index && this.anchors[this.index].$link.removeClass("focus"), this.index = index, 0 < this.index && this.anchors[this.index].$link.addClass("focus"))
    }, MenuHighlight
  }(Backbone.View);
...
function (typedoc) {
  ...
  ! function (search) {
    ...
    var $el = $("#tsd-search"),
      ...
      hasFocus = !1,
      preventPress = !1,
      index, resultClicked = !1;

    function createIndex() {
      var builder = new lunr.Builder;
      builder.pipeline.add(lunr.trimmer), builder.field("name", {
        boost: 10
      }), builder.field("parent"), builder.ref("id");
      var rows = search.data.rows,
        pos = 0,
        length = rows.length;
      ! function batch() {
        for (var cycles = 0; cycles++ < 100;)
          if (builder.add(rows[pos]), ++pos == length) return index = builder.build(), setLoadingState(SearchLoadingState.Ready);
        setTimeout(batch, 10)
      }()
    }
    ...
    function updateResults() {
      if ($results.empty(), loadingState == SearchLoadingState.Ready && query) {
        ...
        for (var i = 0, c = Math.min(10, res.length); i < c; i++) {
          ...
          (parent = parent.replace(new RegExp(query, "i"), function (match) {
            return "<b>" + match + "</b>"
          })) && (name = '<span class="parent">' + parent + ".</span>" + name), $results.append('<li class="' + row.classes + '"><a href="' + base + row.url + '" class="tsd-kind-icon">' + name + "</li>")
        }
      }
    }
    ...
    function setCurrentResult(dir) {
      ...
      if (0 == $current.length) $results.find(1 == dir ? "li:first-child" : "li:last-child").addClass("current");
      else {
        var $rel = 1 == dir ? $current.next("li") : $current.prev("li");
        0 < $rel.length && ($current.removeClass("current"), $rel.addClass("current"))
      }
    }

    function gotoCurrentResult() {
      var $current = $results.find(".current");
      0 == $current.length && ($current = $results.find("li:first-child")), 0 < $current.length && (window.location.href = $current.find("a").prop("href"), $field.blur())
    }
    $results.on("mousedown", function () {
      resultClicked = !0
    }).on("mouseup", function () {
      ...
      resultClicked ? resultClicked = !1 : setTimeout(function () {
      ...
      e.altKey || e.ctrlKey || e.metaKey || !hasFocus && 47 < e.keyCode && e.keyCode < 112 && $field.focus()
    })
...
function (typedoc) {
  ...
  typedoc.transition = function (tuples) {
    for (var name in tuples)
      if (tuples.hasOwnProperty(name) && void 0 !== document.body.style[name]) return {
        name: name,
  ...
  }), typedoc.noTransition = noTransition, typedoc.animateHeight = function ($el, callback, success) {
    var from = $el.height() || 0,
      to = from;
    noTransition($el, function () {
      callback(), $el.css("height", ""), to = $el.height() || 0, from != to && typedoc.transition && $el.css("height", from)
  ...
  var SignatureGroup = function () {
    ...
    Signature = function (_super) {
      function Signature(options) {
        var _this = _super.call(this, options) || this;
        return _this.groups = [], _this.index = -1, _this.createGroups(), _this.$container && (_this.$el.addClass("active").on("touchstart", ".tsd-signature", function (event) {
    ...
    return __extends(Toggle, _super), Toggle.prototype.setActive = function (value) {
      ...
      if (!typedoc.hasPointerMoved && this.active) {
        ...
        if ($path.hasClass("col-menu")) {
          ...
          if ($link.length) {
            var href = window.location.href; - 1 != href.indexOf("#") && (href = href.substr(0, href.indexOf("#"))), $link.prop("href").substr(0, href.length) == href && setTimeout(function () {
